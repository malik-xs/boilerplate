...
class ElementsKit_Widget_Gallery extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__( 'Boilerplate Gallery', 'boilerplate' );
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Gallery Content', 'boilerplate' ),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Filter Label', 'boilerplate' ),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Add Images', 'boilerplate' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Layout', 'boilerplate' ),
            ]
        );
        ...
        $this->add_control(
            'ekit_gallery_style',
            [
                'label' => esc_html__( 'Style', 'boilerplate' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'grid',
                'options' => [
                    'grid' => esc_html__( 'Grid', 'boilerplate' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Columns', 'boilerplate' ),
                'type' => Controls_Manager::SELECT,
                'default' => '3',
                'tablet_default' => '2',
                'mobile_default' => '1',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Image Aspect Ratio', 'boilerplate' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Settings', 'boilerplate' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( '"All" Filter Label', 'boilerplate' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'All', 'boilerplate' ),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label'    => esc_html__( 'Content Alignment', 'boilerplate' ),
                'type'     => Controls_Manager::CHOOSE,
                'options'  => [
                    'left'   => [
                        'title' => esc_html__( 'Left', 'boilerplate' ),
                        'icon'  => 'fa fa-align-left',
                    ],
                    'center' => [
                        'title' => esc_html__( 'Center', 'boilerplate' ),
                        'icon'  => 'fa fa-align-center',
                    ],
                    'right'  => [
                        'title' => esc_html__( 'Right', 'boilerplate' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Alignment', 'boilerplate' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'top' => [
						'title' => esc_html__( 'Top', 'boilerplate' ),
					...
					'bottom' => [
						'title' => esc_html__( 'Bottom', 'boilerplate' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Caption', 'boilerplate' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Description', 'boilerplate' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'boilerplate' ),
				'label_off' => esc_html__( 'Hide', 'boilerplate' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Filter Label', 'boilerplate' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'boilerplate' ),
				'label_off' => esc_html__( 'Hide', 'boilerplate' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Lightbox', 'boilerplate' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'boilerplate' ),
				'label_off' => esc_html__( 'Hide', 'boilerplate' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Lightbox Icon', 'boilerplate' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Image Slideshow', 'boilerplate' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'True', 'boilerplate' ),
				'label_off' => esc_html__( 'Flase', 'boilerplate' ),
				'return_value' => 'yes',
                'default' => 'yes',
                'condition' => [
                    'ekit_gallery_open_lightbox' => 'yes'
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Ordering', 'boilerplate' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => esc_html__( 'Default', 'boilerplate' ),
                    'random' => esc_html__( 'Random', 'boilerplate' ),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Columns Gap', 'boilerplate' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 5,
                    'unit' => 'px',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Rows Padding', 'boilerplate' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Rows Margin', 'boilerplate' ),
				'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'default' => [
                    'top' => '0',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Content Padding', 'boilerplate' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Thumbnails', 'boilerplate' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Normal', 'boilerplate' ),
            ]
        );
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Box Shadow', 'boilerplate' ),
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Hover', 'boilerplate' ),
            ]
        );
        ...
        $ekit_image_filters = [
            ...
            'opacity' => esc_html__( 'Opacity', 'boilerplate' ),
            'scale' => esc_html__( 'Scale', 'boilerplate' ),
            'rotate' => esc_html__( 'Rotate', 'boilerplate' ),
            'blur' => esc_html__( 'Blur', 'boilerplate' ),
            'gray-scale' => esc_html__( 'Gray Scale', 'boilerplate' ),
        ];

        $this->add_control(
            'ekit_gallery_thumbnail_filter',
            [
                'label' => esc_html__( 'Image Filter', 'boilerplate' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'normal',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Blur', 'boilerplate' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Gray Scale', 'boilerplate' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Tilt', 'boilerplate' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Axis', 'boilerplate' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'both',
                'options' => [
                    'both' => esc_html__( 'Both', 'boilerplate' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Amount', 'boilerplate' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Depth', 'boilerplate' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Glare', 'boilerplate' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'boilerplate' ),
				'label_off' => esc_html__( 'Hide', 'boilerplate' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Perspective', 'boilerplate' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Caption', 'boilerplate' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Typography', 'boilerplate' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Margin', 'boilerplate' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Padding', 'boilerplate' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Text Shadow', 'boilerplate' ),
                'selector' => '{{WRAPPER}} .elementskit-single-portfolio-item  .elementskit-gallery-title',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Border Color', 'boilerplate' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Description', 'boilerplate' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Label', 'boilerplate' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Link Icon', 'boilerplate' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'ekit_gallery_open_lightbox' => 'yes',
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Size', 'boilerplate' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 5,
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Font Size', 'boilerplate' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Overlay', 'boilerplate' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $ekit_image_blend_mode = [
            'normal' => esc_html__( 'Normal', 'boilerplate' ),
            'multiply' => esc_html__( 'Multiply', 'boilerplate' ),
            'screen' => esc_html__( 'Screen', 'boilerplate' ),
            'overlay' => esc_html__( 'Overlay', 'boilerplate' ),
            'darken' => esc_html__( 'Darken', 'boilerplate' ),
            'lighten' => esc_html__( 'Lighten', 'boilerplate' ),
            'color-dodge' => esc_html__( 'Color-dodge', 'boilerplate' ),
            'color-burn' => esc_html__( 'Color-burn', 'boilerplate' ),
            'difference' => esc_html__( 'Difference', 'boilerplate' ),
            'exclusion' => esc_html__( 'Exclusion', 'boilerplate' ),
            'hue' => esc_html__( 'hue', 'boilerplate' ),
            'saturation' => esc_html__( 'Saturation', 'boilerplate' ),
            'color' => esc_html__( 'Color', 'boilerplate' ),
            'luminosity' => esc_html__( 'Luminosity', 'boilerplate' ),
        ];

        $this->add_control(
			'ekit_gallery_show_image_overlay',
			[
				'label' => esc_html__( 'Show Overlay', 'boilerplate' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'boilerplate' ),
				'label_off' => esc_html__( 'Hide', 'boilerplate' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Blend Mode', 'boilerplate' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'normal',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Filter', 'boilerplate' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Filter Style', 'boilerplate' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default'  => esc_html__( 'Default', 'boilerplate' ),
					'style_one' => esc_html__( 'Style One', 'boilerplate' ),
					'style_two' => esc_html__( 'Style Two', 'boilerplate' ),
					'style_three' => esc_html__( 'Style Three', 'boilerplate' ),
					'style_four' => esc_html__( 'Style Four', 'boilerplate' ),
					'style_five' => esc_html__( 'Style Five', 'boilerplate' ),
					'style_six' => esc_html__( 'Style Six', 'boilerplate' ),
					'style_seven' => esc_html__( 'Style Seven', 'boilerplate' ),
					'style_eight' => esc_html__( 'Style Eight', 'boilerplate' ),
					'style_nine' => esc_html__( 'Style Nine', 'boilerplate' ),
					'style_ten' => esc_html__( 'Style Ten', 'boilerplate' ),
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Nav Fill', 'boilerplate' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'boilerplate' ),
				'label_off' => esc_html__( 'No', 'boilerplate' ),
				'return_value' => 'yes',
				'default' => 'no',
			]
		);
        ...
        $this->add_responsive_control(
            ...
            [
                'label'    => esc_html__( 'Filter Items Alignment', 'boilerplate' ),
                'type'     => Controls_Manager::CHOOSE,
                'options'  => [
                    'flex-start'   => [
                        'title' => esc_html__( 'Left', 'boilerplate' ),
                    ...
                    'space-between'  => [
                        'title' => esc_html__( 'Justify', 'boilerplate' ),
        ...
        $this->add_control(
            ...
            [
                'label'    => esc_html__( 'Filter Alignment', 'boilerplate' ),
                'type'     => Controls_Manager::CHOOSE,
                'options'  => [
                    'left'   => [
                        'title' => esc_html__( 'Left', 'boilerplate' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Caret', 'boilerplate' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'boilerplate' ),
				'label_off' => esc_html__( 'Hide', 'boilerplate' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Height', 'boilerplate' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Top', 'boilerplate' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Background', 'boilerplate' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Bottom', 'boilerplate' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'%' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Divider', 'boilerplate' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'boilerplate' ),
				'label_off' => esc_html__( 'Hide', 'boilerplate' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Left', 'boilerplate' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Nav Bottom Spacing', 'boilerplate' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Active', 'boilerplate' ),
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container Style', 'boilerplate' ),
