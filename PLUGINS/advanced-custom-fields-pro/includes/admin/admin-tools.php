...
class acf_admin_tools {
	...
	*/
	...
	function admin_menu() {
		...
		// add page
		$page = add_submenu_page('edit.php?post_type=acf-field-group', __('Tools','boilerplate'), __('Tools','boilerplate'), acf_get_setting('capability'), 'acf-tools', array($this, 'html'));
