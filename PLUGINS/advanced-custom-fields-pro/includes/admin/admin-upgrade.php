...
class ACF_Admin_Upgrade {
	...
	*/
	function admin_menu() {
		...
		if( acf_has_upgrade() ) {
			...
			// add page
			$page = add_submenu_page('index.php', __('Upgrade Database','boilerplate'), __('Upgrade Database','boilerplate'), acf_get_setting('capability'), 'acf-upgrade', array($this,'admin_html') );
	...
	function network_admin_menu() {
		...
		$page = add_submenu_page(
			'index.php', 
			__('Upgrade Database','boilerplate'), 
			__('Upgrade Database','boilerplate'), 
	...
	*/
	function admin_notices() {
		...
		// vars
		$view = array(
			'button_text'	=> __("Upgrade Database", 'boilerplate'),
	...
	*/
	function network_admin_notices() {
		...
		// vars
		$view = array(
			'button_text'	=> __("Review sites & upgrade", 'boilerplate'),
