...
<div class="wrap" id="acf-admin-tools">
	...
	<h1><?php _e('Tools', 'boilerplate'); ?> <?php if( $active ): ?><a class="page-title-action" href="<?php echo acf_get_admin_tools_url(); ?>"><?php _e('Back to all tools', 'boilerplate'); ?></a><?php endif; ?></h1>
