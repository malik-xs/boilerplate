	...
	switch ( $object_type ) {
		case 'post':
			if( $object_subtype ) {
				...
				$props['label'] = __('Posts', 'boilerplate');
		...
		case 'term':
			if( $object_subtype ) {
				...
				$props['label'] = __('Taxonomies', 'boilerplate');
			}
			$props['icon'] = 'dashicons-tag';
			break;
		case 'attachment':
			$props['label'] = __('Attachments', 'boilerplate');
			$props['icon'] = 'dashicons-admin-media';
			break;
		case 'comment':
			$props['label'] = __('Comments', 'boilerplate');
			$props['icon'] = 'dashicons-admin-comments';
			break;
		case 'widget':
			$props['label'] = __('Widgets', 'boilerplate');
			$props['icon'] = 'dashicons-screenoptions';
			break;
		case 'menu':
			$props['label'] = __('Menus', 'boilerplate');
			$props['icon'] = 'dashicons-admin-appearance';
			break;
		case 'menu_item':
			$props['label'] = __('Menu items', 'boilerplate');
			$props['icon'] = 'dashicons-admin-appearance';
			break;
		case 'user':
			$props['label'] = __('Users', 'boilerplate');
			$props['icon'] = 'dashicons-admin-users';
			break;
		case 'option':
			$props['label'] = __('Options', 'boilerplate');
			$props['icon'] = 'dashicons-admin-generic';
			break;
		case 'block':
			$props['label'] = __('Blocks', 'boilerplate');
