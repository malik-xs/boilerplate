	...
	function enqueue_scripts(){
		if( wp_script_is('acf-input') ) {
			acf_localize_text(array(
				'Select.verb'			=> _x('Select', 'verb', 'boilerplate'),
				'Edit.verb'				=> _x('Edit', 'verb', 'boilerplate'),
				'Update.verb'			=> _x('Update', 'verb', 'boilerplate'),
				'Uploaded to this post'	=> __('Uploaded to this post', 'boilerplate'),
				'Expand Details' 		=> __('Expand Details', 'boilerplate'),
				'Collapse Details' 		=> __('Collapse Details', 'boilerplate'),
				'Restricted'			=> __('Restricted', 'boilerplate'),
