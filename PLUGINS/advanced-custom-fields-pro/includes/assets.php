...
class ACF_Assets {
	...
	public function enqueue_scripts() {
		...
		acf_localize_text(array(
			...
			// Tooltip
			'Are you sure?'			=> __('Are you sure?','boilerplate'),
			'Yes'					=> __('Yes','boilerplate'),
			'No'					=> __('No','boilerplate'),
			'Remove'				=> __('Remove','boilerplate'),
			'Cancel'				=> __('Cancel','boilerplate'),
		));
		...
		if( wp_script_is('acf-input') ) {
			acf_localize_text(array(
				...
				// Unload
				'The changes you made will be lost if you navigate away from this page'	=> __('The changes you made will be lost if you navigate away from this page', 'boilerplate'),
				
				// Validation
				'Validation successful'			=> __('Validation successful', 'boilerplate'),
				'Validation failed'				=> __('Validation failed', 'boilerplate'),
				'1 field requires attention'	=> __('1 field requires attention', 'boilerplate'),
				'%d fields require attention'	=> __('%d fields require attention', 'boilerplate'),
				
				// Other
				'Edit field group'	=> __('Edit field group', 'boilerplate'),
			));
