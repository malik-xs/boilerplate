	...
	function __construct() {
		...
		$this->fields = array(
			...
			'_validate_email' => array(
				...
				'key'		=> '_validate_email',
				'label'		=> __('Validate Email', 'boilerplate'),
				'type'		=> 'text',
				'value'		=> '',
	...
	*/
	...
	function validate_form( $args ) {
		...
		$args = wp_parse_args( $args, array(
			...
			'html_before_fields'	=> '',
			'html_after_fields'		=> '',
			'submit_value'			=> __("Update", 'boilerplate'),
			'updated_message'		=> __("Post updated", 'boilerplate'),
			'label_placement'		=> 'top',
	...
	*/
	...
	function validate_save_post() {
		...
		if( !empty($_POST['acf']['_validate_email']) ) {
			...
			acf_add_validation_error( '', __('Spam Detected', 'boilerplate') );
