...
class ACF_Location_Page_Type extends ACF_Location {
	...
	public function initialize() {
		$this->name = 'page_type';
		$this->label = __( "Page Type", 'boilerplate' );
		$this->category = 'page';
	...
	public function get_values( $rule ) {
		return array(
			'front_page'	=> __("Front Page",'boilerplate'),
			'posts_page'	=> __("Posts Page",'boilerplate'),
			'top_level'		=> __("Top Level Page (no parent)",'boilerplate'),
			'parent'		=> __("Parent Page (has children)",'boilerplate'),
			'child'			=> __("Child Page (has parent)",'boilerplate'),
		);
	}
}
