...
class ACF_Location_Current_User extends ACF_Location {
	...
	public function initialize() {
		...
		$this->label = __( "Current User", 'boilerplate' );
		$this->category = 'user';
	}
	...
	public function get_values( $rule ) {
		return array(
			'logged_in'		=> __( 'Logged in', 'boilerplate' ),
			'viewing_front'	=> __( 'Viewing front end', 'boilerplate' ),
			'viewing_back'	=> __( 'Viewing back end', 'boilerplate' )
		);
	}
}
