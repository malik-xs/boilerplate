...
function acf_get_field_type_label( $name = '' ) {
	...
	return $label ? $label : '<span class="acf-tooltip-js" title="'.__('Field type does not exist', 'boilerplate').'">'.__('Unknown', 'boilerplate').'</span>';
}
...
function acf_get_grouped_field_types() {
	...
	$groups = array();
	$l10n = array(
		'basic'			=> __('Basic', 'boilerplate'),
		'content'		=> __('Content', 'boilerplate'),
		'choice'		=> __('Choice', 'boilerplate'),
		'relational'	=> __('Relational', 'boilerplate'),
		'jquery'		=> __('jQuery', 'boilerplate'),
