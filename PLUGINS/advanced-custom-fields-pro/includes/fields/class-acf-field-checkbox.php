...
class acf_field_checkbox extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'checkbox';
		$this->label = __("Checkbox",'boilerplate');
	...
	*/
	...
	function render_field_toggle( $field ) {
		...
		$atts = array(
			...
			'label'	=> __("Toggle All", 'boilerplate')
		);
	...
	*/
	...
	function render_field_custom( $field ) {
		...
		// append button
		$html .= '<li><a href="#" class="button acf-add-checkbox">' . esc_attr__('Add new choice', 'boilerplate') . '</a></li>' . "\n";
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		// other_choice
		acf_render_field_setting( $field, array(
			'label'			=> __('Allow Custom','boilerplate'),
			'instructions'	=> '',
			'name'			=> 'allow_custom',
			'type'			=> 'true_false',
			'ui'			=> 1,
			'message'		=> __("Allow 'custom' values to be added", 'boilerplate'),
		));
		
		
		// save_other_choice
		acf_render_field_setting( $field, array(
			'label'			=> __('Save Custom','boilerplate'),
			'instructions'	=> '',
			'name'			=> 'save_custom',
			'type'			=> 'true_false',
			'ui'			=> 1,
			'message'		=> __("Save 'custom' values to the field's choices", 'boilerplate'),
			'conditions'	=> array(
				'field'		=> 'allow_custom',
				'operator'	=> '==',
				'value'		=> 1
		...
		acf_render_field_setting( $field, array(
			...
			'layout'		=> 'horizontal', 
			'choices'		=> array(
				'vertical'		=> __("Vertical",'boilerplate'), 
				'horizontal'	=> __("Horizontal",'boilerplate')
			)
		));
		...
		// layout
		acf_render_field_setting( $field, array(
			'label'			=> __('Toggle','boilerplate'),
			'instructions'	=> __('Prepend an extra checkbox to toggle all choices','boilerplate'),
			'name'			=> 'toggle',
			'type'			=> 'true_false',
			'ui'			=> 1,
		));
