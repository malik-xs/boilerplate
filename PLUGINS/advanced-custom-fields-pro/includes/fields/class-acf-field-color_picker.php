...
class acf_field_color_picker extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Color Picker",'boilerplate');
		...
		if( !is_admin() ) {
			...
			// WP 4.9
				...
				$scripts->localize( 'wp-color-picker', 'wpColorPickerL10n', array(
					'clear'            => __( 'Clear', 'boilerplate' ),
					'clearAriaLabel'   => __( 'Clear color', 'boilerplate' ),
					'defaultString'    => __( 'Default', 'boilerplate' ),
					'defaultAriaLabel' => __( 'Select default color', 'boilerplate' ),
					'pick'             => __( 'Select Color', 'boilerplate' ),
					'defaultLabel'     => __( 'Color value', 'boilerplate' ),
				));
			}
