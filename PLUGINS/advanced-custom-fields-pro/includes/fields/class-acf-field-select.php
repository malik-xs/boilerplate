...
class acf_field_select extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'select';
		$this->label = _x('Select', 'noun', 'boilerplate');
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		acf_localize_data(array(
		   	'select2L10n'	=> array(
				'matches_1'				=> _x('One result is available, press enter to select it.',	'Select2 JS matches_1',	'boilerplate'),
				'matches_n'				=> _x('%d results are available, use up and down arrow keys to navigate.',	'Select2 JS matches_n',	'boilerplate'),
				'matches_0'				=> _x('No matches found',	'Select2 JS matches_0',	'boilerplate'),
				'input_too_short_1'		=> _x('Please enter 1 or more characters', 'Select2 JS input_too_short_1', 'boilerplate' ),
				'input_too_short_n'		=> _x('Please enter %d or more characters', 'Select2 JS input_too_short_n', 'boilerplate' ),
				'input_too_long_1'		=> _x('Please delete 1 character', 'Select2 JS input_too_long_1', 'boilerplate' ),
				'input_too_long_n'		=> _x('Please delete %d characters', 'Select2 JS input_too_long_n', 'boilerplate' ),
				'selection_too_long_1'	=> _x('You can only select 1 item', 'Select2 JS selection_too_long_1', 'boilerplate' ),
				'selection_too_long_n'	=> _x('You can only select %d items', 'Select2 JS selection_too_long_n', 'boilerplate' ),
				'load_more'				=> _x('Loading more results&hellip;', 'Select2 JS load_more', 'boilerplate' ),
				'searching'				=> _x('Searching&hellip;', 'Select2 JS searching', 'boilerplate' ),
				'load_fail'           	=> _x('Loading failed', 'Select2 JS load_fail', 'boilerplate' ),
			)
	   	));
	}
	...
	*/
	...
	function render_field( $field ) {
		...
		if( empty($field['placeholder']) ) {
			$field['placeholder'] = _x('Select', 'verb', 'boilerplate');
		}
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Choices','boilerplate'),
			'instructions'	=> __('Enter each choice on a new line.','boilerplate') . '<br /><br />' . __('For more control, you may specify both a value and label like this:','boilerplate'). '<br /><br />' . __('red : Red','boilerplate'),
			'name'			=> 'choices',
			'type'			=> 'textarea',
		));	
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Enter each default value on a new line','boilerplate'),
			'name'			=> 'default_value',
			'type'			=> 'textarea',
		));
		...
		// allow_null
		acf_render_field_setting( $field, array(
			'label'			=> __('Allow Null?','boilerplate'),
			'instructions'	=> '',
			'name'			=> 'allow_null',
			'type'			=> 'true_false',
			'ui'			=> 1,
		...
		// multiple
		acf_render_field_setting( $field, array(
			'label'			=> __('Select multiple values?','boilerplate'),
			'instructions'	=> '',
			'name'			=> 'multiple',
			'type'			=> 'true_false',
			'ui'			=> 1,
		...
		// ui
		acf_render_field_setting( $field, array(
			'label'			=> __('Stylised UI','boilerplate'),
			'instructions'	=> '',
			'name'			=> 'ui',
			'type'			=> 'true_false',
			'ui'			=> 1,
		...
		// ajax
		acf_render_field_setting( $field, array(
			'label'			=> __('Use AJAX to lazy load choices?','boilerplate'),
			'instructions'	=> '',
			'name'			=> 'ajax',
			'type'			=> 'true_false',
			'ui'			=> 1,
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Specify the value returned','boilerplate'),
			'type'			=> 'select',
			'name'			=> 'return_format',
			'choices'		=> array(
				'value'			=> __('Value','boilerplate'),
				'label'			=> __('Label','boilerplate'),
				'array'			=> __('Both (Array)','boilerplate')
			)
		));
