...
*/
		...
		// preview_size
		acf_render_field_setting( $field, array(
			'label'			=> __('Placement','boilerplate'),
			'type'			=> 'select',
			'name'			=> 'placement',
			'choices' 		=> array(
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Define an endpoint for the previous tabs to stop. This will start a new group of tabs.', 'boilerplate'),
			'name'			=> 'endpoint',
			'type'			=> 'true_false',
			'ui'			=> 1,
		));
