...
class acf_field_file extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'file';
		$this->label = __("File",'boilerplate');
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		acf_localize_text(array(
		   	'Select File'	=> __('Select File', 'boilerplate'),
			'Edit File'		=> __('Edit File', 'boilerplate'),
			'Update File'	=> __('Update File', 'boilerplate'),
	   	));
	}
...
<div <?php acf_esc_attr_e( $div ); ?>>
	...
	<div class="show-if-value file-wrap">
		...
		<div class="file-info">
			...
			<p>
				<strong><?php _e('File name', 'boilerplate'); ?>:</strong>
				<a data-name="filename" href="<?php echo esc_url($o['url']); ?>" target="_blank"><?php echo esc_html($o['filename']); ?></a>
			</p>
			<p>
				<strong><?php _e('File size', 'boilerplate'); ?>:</strong>
				<span data-name="filesize"><?php echo esc_html($o['filesize']); ?></span>
			</p>
		</div>
		<div class="acf-actions -hover">
			<?php if( $uploader != 'basic' ): ?>
			<a class="acf-icon -pencil dark" data-name="edit" href="#" title="<?php _e('Edit', 'boilerplate'); ?>"></a>
			<?php endif; ?>
			<a class="acf-icon -cancel dark" data-name="remove" href="#" title="<?php _e('Remove', 'boilerplate'); ?>"></a>
		</div>
	</div>
	<div class="hide-if-value">
		...
		<?php else: ?>
			...
			<p><?php _e('No file selected','boilerplate'); ?> <a data-name="add" class="acf-button button" href="#"><?php _e('Add File','boilerplate'); ?></a></p>
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Specify the returned value on front end','boilerplate'),
			'type'			=> 'radio',
			'name'			=> 'return_format',
			'layout'		=> 'horizontal',
			'choices'		=> array(
				'array'			=> __("File Array",'boilerplate'),
				'url'			=> __("File URL",'boilerplate'),
				'id'			=> __("File ID",'boilerplate')
			)
		));
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Restrict which files can be uploaded','boilerplate'),
			'type'			=> 'text',
			'name'			=> 'min_size',
