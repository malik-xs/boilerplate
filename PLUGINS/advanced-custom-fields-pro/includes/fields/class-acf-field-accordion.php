...
class acf_field__accordion extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'accordion';
		$this->label = __("Accordion",'boilerplate');
...
*/
		...
		// active
		acf_render_field_setting( $field, array(
			'label'			=> __('Open','boilerplate'),
			'instructions'	=> __('Display this accordion as open on page load.','boilerplate'),
			'name'			=> 'open',
			'type'			=> 'true_false',
			'ui'			=> 1,
		));
		...
		// multi_expand
		acf_render_field_setting( $field, array(
			'label'			=> __('Multi-expand','boilerplate'),
			'instructions'	=> __('Allow this accordion to open without closing others.','boilerplate'),
			'name'			=> 'multi_expand',
			'type'			=> 'true_false',
			'ui'			=> 1,
		));
		...
		// endpoint
		acf_render_field_setting( $field, array(
			'label'			=> __('Endpoint','boilerplate'),
			'instructions'	=> __('Define an endpoint for the previous accordion to stop. This accordion will not be visible.','boilerplate'),
			'name'			=> 'endpoint',
			'type'			=> 'true_false',
			'ui'			=> 1,
		));
