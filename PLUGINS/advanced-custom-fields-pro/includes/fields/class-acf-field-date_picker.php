...
class acf_field_date_picker extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Date Picker",'boilerplate');
		...
		// bail ealry if no enqueue
	   	...
	   	acf_localize_data(array(
		   	'datePickerL10n'	=> array(
				'closeText'			=> _x('Done',	'Date Picker JS closeText',		'boilerplate'),
				'currentText'		=> _x('Today',	'Date Picker JS currentText',	'boilerplate'),
				'nextText'			=> _x('Next',	'Date Picker JS nextText',		'boilerplate'),
				'prevText'			=> _x('Prev',	'Date Picker JS prevText',		'boilerplate'),
				'weekHeader'		=> _x('Wk',		'Date Picker JS weekHeader',	'boilerplate'),
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		if( !empty($field['save_format']) ) {
			...
			// save_format
			acf_render_field_setting( $field, array(
				'label'			=> __('Save Format','boilerplate'),
				'instructions'	=> __('The format used when saving a value','boilerplate'),
				'type'			=> 'text',
				'name'			=> 'save_format',
