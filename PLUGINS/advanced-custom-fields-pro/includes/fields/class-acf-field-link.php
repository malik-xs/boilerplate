...
class acf_field_link extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'link';
		$this->label = __("Link",'boilerplate');
...
<div <?php acf_esc_attr_e($div); ?>>
	...
	<a href="#" class="button" data-name="add" target=""><?php _e('Select Link', 'boilerplate'); ?></a>
	...
	<div class="link-wrap">
		...
		<i class="acf-icon -link-ext acf-js-tooltip" title="<?php _e('Opens in a new window/tab', 'boilerplate'); ?>"></i><?php
		?><a class="acf-icon -pencil -clear acf-js-tooltip" data-name="edit" href="#" title="<?php _e('Edit', 'boilerplate'); ?>"></a><?php
		?><a class="acf-icon -cancel -clear acf-js-tooltip" data-name="remove" href="#" title="<?php _e('Remove', 'boilerplate'); ?>"></a>
	</div>
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			...
			'layout'		=> 'horizontal',
			'choices'		=> array(
				'array'			=> __("Link Array",'boilerplate'),
				'url'			=> __("Link URL",'boilerplate'),
			)
		));
