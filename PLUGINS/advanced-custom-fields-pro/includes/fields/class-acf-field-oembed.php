...
class acf_field_oembed extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'oembed';
		$this->label = __("oEmbed",'boilerplate');
...
<div <?php acf_esc_attr_e($atts) ?>>
	...
	<div class="title">
		<?php acf_text_input(array( 'class' => 'input-search', 'value' => $field['value'], 'placeholder' => __("Enter URL", 'boilerplate'), 'autocomplete' => 'off'  )); ?>
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Embed Size','boilerplate'),
			'type'			=> 'text',
			'name'			=> 'width',
