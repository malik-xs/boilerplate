...
class acf_field_true_false extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __('True / False','boilerplate');
	...
	*/
	...
	function render_field( $field ) {
		...
		if( $field['ui'] ) {
			...
			// vars
			if( $field['ui_on_text'] === '' ) $field['ui_on_text'] = __('Yes', 'boilerplate');
			if( $field['ui_off_text'] === '' ) $field['ui_off_text'] = __('No', 'boilerplate');
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Displays text alongside the checkbox','boilerplate'),
			'type'			=> 'text',
			'name'			=> 'message',
		));
		...
		// on_text
		acf_render_field_setting( $field, array(
			'label'			=> __('On Text','boilerplate'),
			'instructions'	=> __('Text shown when active','boilerplate'),
			'type'			=> 'text',
			'name'			=> 'ui_on_text',
			'placeholder'	=> __('Yes', 'boilerplate'),
			'conditions'	=> array(
				'field'		=> 'ui',
				'operator'	=> '==',
				'value'		=> 1
		...
		// on_text
		acf_render_field_setting( $field, array(
			'label'			=> __('Off Text','boilerplate'),
			'instructions'	=> __('Text shown when inactive','boilerplate'),
			'type'			=> 'text',
			'name'			=> 'ui_off_text',
			'placeholder'	=> __('No', 'boilerplate'),
			'conditions'	=> array(
				'field'		=> 'ui',
				'operator'	=> '==',
				'value'		=> 1
