...
class acf_field_radio extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'radio';
		$this->label = __("Radio Button",'boilerplate');
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		// other_choice
		acf_render_field_setting( $field, array(
			'label'			=> __('Other','boilerplate'),
			'instructions'	=> '',
			'name'			=> 'other_choice',
			'type'			=> 'true_false',
			'ui'			=> 1,
			'message'		=> __("Add 'other' choice to allow for custom values", 'boilerplate'),
		));
		
		
		// save_other_choice
		acf_render_field_setting( $field, array(
			'label'			=> __('Save Other','boilerplate'),
			'instructions'	=> '',
			'name'			=> 'save_other_choice',
			'type'			=> 'true_false',
			'ui'			=> 1,
			'message'		=> __("Save 'other' values to the field's choices", 'boilerplate'),
			'conditions'	=> array(
				'field'		=> 'other_choice',
				'operator'	=> '==',
				'value'		=> 1
