...
class acf_field_wysiwyg extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'wysiwyg';
		$this->label = __("Wysiwyg Editor",'boilerplate');
			...
			<div id="wp-<?php echo $id; ?>-editor-tools" class="wp-editor-tools hide-if-no-js">
				...
				<?php if( user_can_richedit() && $show_tabs ): ?>
					<div class="wp-editor-tabs">
						<button id="<?php echo $id; ?>-tmce" class="wp-switch-editor switch-tmce" <?php echo $button; ?> type="button"><?php echo __('Visual', 'boilerplate'); ?></button>
						<button id="<?php echo $id; ?>-html" class="wp-switch-editor switch-html" <?php echo $button; ?> type="button"><?php echo _x( 'Text', 'Name for the Text editor tab (formerly HTML)', 'boilerplate' ); ?></button>
					</div>
				<?php endif; ?>
			</div>
			<div id="wp-<?php echo $id; ?>-editor-container" class="wp-editor-container">
				<?php if( $field['delay'] ): ?>
					<div class="acf-editor-toolbar"><?php _e('Click to initialize TinyMCE', 'boilerplate'); ?></div>
				<?php endif; ?>
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		// tabs
		acf_render_field_setting( $field, array(
			'label'			=> __('Tabs','boilerplate'),
			'instructions'	=> '',
			'type'			=> 'select',
			'name'			=> 'tabs',
			'choices'		=> array(
				'all'			=>	__("Visual & Text",'boilerplate'),
				'visual'		=>	__("Visual Only",'boilerplate'),
				'text'			=>	__("Text Only",'boilerplate'),
			)
		));
		...
		// media_upload
		acf_render_field_setting( $field, array(
			'label'			=> __('Show Media Upload Buttons?','boilerplate'),
			'instructions'	=> '',
			'name'			=> 'media_upload',
			'type'			=> 'true_false',
			'ui'			=> 1,
		...
		// delay
		acf_render_field_setting( $field, array(
			'label'			=> __('Delay initialization?','boilerplate'),
			'instructions'	=> __('TinyMCE will not be initialized until field is clicked','boilerplate'),
			'name'			=> 'delay',
			'type'			=> 'true_false',
			'ui'			=> 1,
			'conditions'	=> array(
