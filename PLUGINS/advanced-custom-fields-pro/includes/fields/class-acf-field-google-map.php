...
class acf_field_google_map extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Google Map",'boilerplate');
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		acf_localize_text(array(
			'Sorry, this browser does not support geolocation'	=> __('Sorry, this browser does not support geolocation', 'boilerplate'),
	   	));
...
<div <?php acf_esc_attr_e($attrs); ?>>
	...
	<div class="title">
		...
		<div class="acf-actions -hover">
			<a href="#" data-name="search" class="acf-icon -search grey" title="<?php _e("Search", 'boilerplate'); ?>"></a>
			<a href="#" data-name="clear" class="acf-icon -cancel grey" title="<?php _e("Clear location", 'boilerplate'); ?>"></a>
			<a href="#" data-name="locate" class="acf-icon -location grey" title="<?php _e("Find current location", 'boilerplate'); ?>"></a>
		</div>
		
		<input class="search" type="text" placeholder="<?php _e("Search for address...",'boilerplate'); ?>" value="<?php echo esc_attr( $search ); ?>" />
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Center','boilerplate'),
			'instructions'	=> __('Center the initial map','boilerplate'),
			'type'			=> 'text',
			'name'			=> 'center_lat',
			'prepend'		=> 'lat',
		...
		// zoom
		acf_render_field_setting( $field, array(
			'label'			=> __('Zoom','boilerplate'),
			'instructions'	=> __('Set the initial zoom level','boilerplate'),
			'type'			=> 'text',
			'name'			=> 'zoom',
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Customize the map height','boilerplate'),
			'type'			=> 'text',
			'name'			=> 'height',
			'append'		=> 'px',
