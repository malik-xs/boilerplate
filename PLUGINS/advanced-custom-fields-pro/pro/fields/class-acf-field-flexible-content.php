...
class acf_field_flexible_content extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Flexible Content",'boilerplate');
		$this->category = 'layout';
		$this->defaults = array(
			'layouts'		=> array(),
			'min'			=> '',
			'max'			=> '',
			'button_label'	=> __("Add Row",'boilerplate'),
		);
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		acf_localize_text(array(
			...
			// identifiers
		   	'layout'													=> __('layout', 'boilerplate'),
			'layouts'													=> __('layouts', 'boilerplate'),
			
			// min / max
			'This field requires at least {min} {label} {identifier}'	=> __('This field requires at least {min} {label} {identifier}', 'boilerplate'),
			'This field has a limit of {max} {label} {identifier}'		=> __('This field has a limit of {max} {label} {identifier}', 'boilerplate'),
			
			// popup badge
			'{available} {label} {identifier} available (max {max})'	=> __('{available} {label} {identifier} available (max {max})', 'boilerplate'),
			'{required} {label} {identifier} required (min {min})'		=> __('{required} {label} {identifier} required (min {min})', 'boilerplate'),
			
			// field settings
			'Flexible Content requires at least 1 layout'				=> __('Flexible Content requires at least 1 layout', 'boilerplate')
	   	));
	}
	...
	*/
	...
	function render_field( $field ) {
		...
		// no value message
		$no_value_message = __('Click the "%s" button below to start creating your layout','boilerplate');
...
<div <?php echo acf_esc_attr($div); ?>>
	...
	<div class="acf-fc-layout-handle" title="<?php _e('Drag to reorder','boilerplate'); ?>" data-name="collapse-layout"><?php echo $title; ?></div>
	
	<div class="acf-fc-layout-controls">
		<a class="acf-icon -plus small light acf-js-tooltip" href="#" data-name="add-layout" title="<?php _e('Add layout','boilerplate'); ?>"></a>
		<a class="acf-icon -duplicate small light acf-js-tooltip" href="#" data-name="duplicate-layout" title="<?php _e('Duplicate layout','boilerplate'); ?>"></a>
		<a class="acf-icon -minus small light acf-js-tooltip" href="#" data-name="remove-layout" title="<?php _e('Remove layout','boilerplate'); ?>"></a>
		<a class="acf-icon -collapse small -clear acf-js-tooltip" href="#" data-name="collapse-layout" title="<?php _e('Click to toggle','boilerplate'); ?>"></a>
	</div>
...
?><tr class="acf-field acf-field-setting-fc_layout" data-name="fc_layout" data-setting="flexible_content" data-id="<?php echo $layout['key']; ?>">
	<td class="acf-label">
		<label><?php _e("Layout",'boilerplate'); ?></label>
		<ul class="acf-bl acf-fl-actions">
			<li><a class="reorder-layout" href="#" title="<?php _e("Reorder Layout",'boilerplate'); ?>"><?php _e("Reorder",'boilerplate'); ?></a></li>
			<li><a class="delete-layout" href="#" title="<?php _e("Delete Layout",'boilerplate'); ?>"><?php _e("Delete",'boilerplate'); ?></a></li>
			<li><a class="duplicate-layout" href="#" title="<?php _e("Duplicate Layout",'boilerplate'); ?>"><?php _e("Duplicate",'boilerplate'); ?></a></li>
			<li><a class="add-layout" href="#" title="<?php _e("Add New Layout",'boilerplate'); ?>"><?php _e("Add New",'boilerplate'); ?></a></li>
		</ul>
	</td>
	<td class="acf-input">
		<?php 
		...
		<ul class="acf-fc-meta acf-bl">
			...
			<li class="acf-fc-meta-name">
				...
				acf_render_field(array(
					...
					'prefix'	=> $layout_prefix,
					'value'		=> $layout['name'],
					'prepend'	=> __('Name','boilerplate')
				));
				
				?>
			</li>
			<li class="acf-fc-meta-display">
				<div class="acf-input-prepend"><?php _e('Layout','boilerplate'); ?></div>
				<div class="acf-input-wrap">
					...
					acf_render_field(array(
						...
						'choices'	=> array(
							'table'			=> __('Table','boilerplate'),
							'block'			=> __('Block','boilerplate'),
							'row'			=> __('Row','boilerplate')
						),
					));
...
<?php
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Button Label','boilerplate'),
			'instructions'	=> '',
			'type'			=> 'text',
			'name'			=> 'button_label',
		));
		...
		// min
		acf_render_field_setting( $field, array(
			'label'			=> __('Minimum Layouts','boilerplate'),
			'instructions'	=> '',
			'type'			=> 'number',
			'name'			=> 'min',
		));
		...
		// max
		acf_render_field_setting( $field, array(
			'label'			=> __('Maximum Layouts','boilerplate'),
			'instructions'	=> '',
			'type'			=> 'number',
			'name'			=> 'max',
		));
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $min && $count < $min ) {
			...
			// vars
			$error = __('This field requires at least {min} {label} {identifier}', 'boilerplate');
			$identifier = _n('layout', 'layouts', $min, 'boilerplate');
