...
class acf_field_clone extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'clone';
		$this->label = _x('Clone', 'noun', 'boilerplate');
...
<?php
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Fields', 'boilerplate'),
			'instructions'	=> __('Select one or more fields you wish to clone','boilerplate'),
			'type'			=> 'select',
			'name'			=> 'clone',
			'multiple' 		=> 1,
			'allow_null' 	=> 1,
		...
		// display
		acf_render_field_setting( $field, array(
			'label'			=> __('Display','boilerplate'),
			'instructions'	=> __('Specify the style used to render the clone field', 'boilerplate'),
			'type'			=> 'select',
			'name'			=> 'display',
			'class'			=> 'setting-display',
			'choices'		=> array(
				'group'			=> __('Group (displays selected fields in a group within this field)','boilerplate'),
				'seamless'		=> __('Seamless (replaces this field with selected fields)','boilerplate'),
			),
		));
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Specify the style used to render the selected fields', 'boilerplate'),
			'type'			=> 'radio',
			'name'			=> 'layout',
			'layout'		=> 'horizontal',
			'choices'		=> array(
		...
		// prefix_label
		$instructions = __('Labels will be displayed as %s', 'boilerplate');
		$instructions = sprintf($instructions, '<code class="prefix-label-code-1"></code>');
		acf_render_field_setting( $field, array(
			'label'			=> __('Prefix Field Labels','boilerplate'),
		...
		// prefix_name
		$instructions = __('Values will be saved as %s', 'boilerplate');
		$instructions = sprintf($instructions, '<code class="prefix-name-code-1"></code>');
		acf_render_field_setting( $field, array(
			'label'			=> __('Prefix Field Names','boilerplate'),
			'message'	=> $instructions,
			//'instructions_placement'	=> 'field',
			'name'			=> 'prefix_name',
	...
	*/
	...
	function get_clone_setting_field_choice( $field ) {
		...
		if( !$field ) return __('Unknown field', 'boilerplate');
		
		
		// title
		$title = $field['label'] ? $field['label'] : __('(no title)', 'boilerplate');
	...
	*/
	...
	function get_clone_setting_group_choice( $field_group ) {
		...
		if( !$field_group ) return __('Unknown field group', 'boilerplate');
		
		
		// return
		return sprintf( __('All fields from %s field group', 'boilerplate'), $field_group['title'] );
