...
class ACF {
	...
	function initialize() {
		...
		// Define settings.
		$this->settings = array(
			'name'						=> __('Advanced Custom Fields', 'boilerplate'),
	...
	function register_post_types() {
		...
		register_post_type('acf-field-group', array(
			'labels'			=> array(
			    'name'					=> __( 'Field Groups', 'boilerplate' ),
				'singular_name'			=> __( 'Field Group', 'boilerplate' ),
			    'add_new'				=> __( 'Add New' , 'boilerplate' ),
			    'add_new_item'			=> __( 'Add New Field Group' , 'boilerplate' ),
			    'edit_item'				=> __( 'Edit Field Group' , 'boilerplate' ),
			    'new_item'				=> __( 'New Field Group' , 'boilerplate' ),
			    'view_item'				=> __( 'View Field Group', 'boilerplate' ),
			    'search_items'			=> __( 'Search Field Groups', 'boilerplate' ),
			    'not_found'				=> __( 'No Field Groups found', 'boilerplate' ),
			    'not_found_in_trash'	=> __( 'No Field Groups found in Trash', 'boilerplate' ), 
			),
			'public'			=> false,
			'hierarchical'		=> true,
			'show_ui'			=> true,
		...
		register_post_type('acf-field', array(
			'labels'			=> array(
			    'name'					=> __( 'Fields', 'boilerplate' ),
				'singular_name'			=> __( 'Field', 'boilerplate' ),
			    'add_new'				=> __( 'Add New' , 'boilerplate' ),
			    'add_new_item'			=> __( 'Add New Field' , 'boilerplate' ),
			    'edit_item'				=> __( 'Edit Field' , 'boilerplate' ),
			    'new_item'				=> __( 'New Field' , 'boilerplate' ),
			    'view_item'				=> __( 'View Field', 'boilerplate' ),
			    'search_items'			=> __( 'Search Fields', 'boilerplate' ),
			    'not_found'				=> __( 'No Fields found', 'boilerplate' ),
			    'not_found_in_trash'	=> __( 'No Fields found in Trash', 'boilerplate' ), 
			),
			'public'			=> false,
			'hierarchical'		=> true,
			'show_ui'			=> false,
	...
	function register_post_status() {
		...
		register_post_status('acf-disabled', array(
			'label'                     => _x( 'Disabled', 'post status', 'boilerplate' ),
			'public'                    => true,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'Disabled <span class="count">(%s)</span>', 'Disabled <span class="count">(%s)</span>', 'boilerplate' ),
		));
	}
