<?php
   ...
   $blog_author = boilerplate_option('blog_author_show');
...
<div class="author-box solid-bg">
    ...
    <div class="author-info">
        <h3 class="post_author_title">
            ...
            <a class="author-url" href="<?php echo get_the_author_meta('user_url'); ?>">(<?php echo esc_html__( 'Website', 'boilerplate' ); ?>)</a>
            <?php } ?>
        </h3>
        ...
        <?php
            ...
            if ($authorData) {
               if (in_array( 'administrator', $authorData->roles) || in_array( 'editor', $authorData->roles) || in_array( 'author', $authorData->roles) || in_array( 'contributor', $authorData->roles) || in_array( 'subscriber', $authorData->roles)) {
                  ...
                  echo esc_html__( 'Super Admin', 'boilerplate' );
               }
            }
        ?>
        </p>
